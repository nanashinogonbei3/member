...
try{
            ...
            FROM my_recipes JOIN members ON my_recipes.members_id = members.id
            WHERE my_recipes.members_id = members.id AND 
            my_recipes.is_released = 1 AND my_recipes.is_deleted = 0
            ORDER BY my_recipes.id DESC";
            // レシピ名にリンクを付けました
...
<body>
   ...
   <div class='div_p'>my recipes notes
        ...
        <?php if ($_SESSION['member'] == 104) : ?>
            <!-- 管理者頁 -->
            <div class="div_logout"><input type="button"  value='商品管理' class="product_btn"
                      onclick="location.href='../product/index.php'" >
        ...
        <!-- ログアウト -->
        <div class="div_logout1">
                        <input type="button"  value='ログアウト' class="logout_btn"
    ...
    <form action="serch_mushimegane.php" method="GET">
        ...
        <!-- 虫眼鏡検索で何か入力がされたら、 -->
        <input type="text" class="form-input" name="serch" value="" placeholder='serch' maxlength="24"/>
      
        <!-- 虫眼鏡のボタン -->
        <button name="send" type="mushimegane" class="form-button" type="submit">
          <img id="mushimegane" src="./css_img/mushimegane.png" >
        </button>
       ...
       <dt>●具材・色</dt>   
        ...
        <form action="serch_material.php" method="GET">
          ...
          <form action="serch_material_multiple.php" method="GET">
                <table>
                <dt>●食材で選ぶ</dt>
                <td><input id="material_text" type="text" name="material" value='' 
                  size="20" maxlength="20" placeholder='食材で選ぶ' maxength="255" ></td>
                <td class="menu"></td>
                </table>
              <!-- 送信ボタン③ボタン -->        
              <div class="btn">
          ...
          <form action="serch_member.php" method="GET">
                ...
                <dt>●メンバーのレシピ検索</dt>
                  <tr>
                    <td>
                      <input id="material_text" type="text" name="name" value=''    
                      size="20" maxlength="20" placeholder='ニックネームで探す' maxength="255" >
                    </td>
          ...
          <form action="serch_recipe_id.php" method="GET">
                ...
                <dt>●レシピID検索</dt>
                  <tr>
                    <td><input id="material_text" type="text" name="serch" value=''    
                    size="20" maxlength="20" placeholder='レシピIDで探す' maxength="255" ></td>
                    <td></td>
...
<div class="block1">
  ...
  <!-- ログインしていたら -->
    ...
    <input id="all" type="radio" value="./confirm.php" onclick="location.href=this.value" name="tab_item" checked>
    ...
    <label class="tab_item" for="all">みんなのレシピ</label>
      <!-- for="all" みんなのレシピ -->
    <input id="programming" type="radio" value="./login_recipe.php" onclick="location.href=this.value" name="tab_item">
      <label class="tab_item" for="programming">わたしのレシピ</label>
      <!-- for="programming" わたしのレシピ -->
    <input id="design" type="radio" value="../create/recipe/index.php" onclick="location.href=this.value" name="tab_item" <?php echo $_SESSION['member'] ?>>
...
<form action="../edit/recipe/release_recipe.php" method="post" enctype="multipart/form-data">
  ...
  <img id="img" src="../create/recipe/images/<?php echo $list[0]['complete_img'] ?>" 
  onclick="changeimg(../create/recipe/images/<?php echo $list[0]['complete_img'] ?>)">
  <!-- 大きいサムネイル画像 -->
                ...
                <!-- 入力フォーム 材料入力 -->
                    ...
                    ?>
                        <table width: 150px>
                            <thead>
                                <tr>
                                    <th><dt class="wf-sawarabimincho">id</th>
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <th><dt class="wf-sawarabimincho">レシピ名</th>
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <th><dt class="wf-sawarabimincho">作った人</th>
                                      <td>&nbsp;&nbsp;</td>
                                      <td>&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      </td>
                                    <th><dt class="wf-sawarabimincho">公開日</th>
                                </tr>
                            </thead>
                              ...
                              <?php foreach ($data as $val) : ?>
                                ...
                                <tr>
                                        ...
                                        <td class="td" width="115px" height="10px">
                                          ...
                                          <span style="color:green;font-size:13px"><?php echo $val['nickname'] ?></span></td>
                              ...
                              <?php
                                ...
                                for ( $n = 1; $n <= 8; $n ++){
                                    if ( $n == $now ){
                                        ...
                                        echo "<a href='./confirm.php?page_id=$n' style='padding: 5px;'>$n</a>";
