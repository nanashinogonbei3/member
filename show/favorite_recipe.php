...
try {
    ...
    $sql = "SELECT *
            ...
            JOIN my_recipes ON favorite_recipes.favorite_recipe_id
             = my_recipes.id
            WHERE favorite_recipes.members_id = '" . $_SESSION['member'] . "' ";
    ...
    $select = $dbh->prepare("SELECT distinct *
            ...
            WHERE favorite_recipes.members_id = '" . $_SESSION['member'] .
        "' AND favorite_recipes.is_completed = 1
            ORDER BY favorite_recipes.favorite_recipe_id DESC LIMIT :start,:max ");
...
<body>
    ...
    <div class="item_6">
        ...
        <div class="inlineBlock">
            ...
            <input type="button" value="みんなのレシピ" class="shop-order" onclick="
        location.href='../top/confirm.php'">
        </div>
