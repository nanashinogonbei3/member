...
try {
    ...
    if (empty($_GET['id']) || empty($id)) {
        ...
        $sql = "SELECT favorite_product_id, is_completed
             FROM favorite_products
            INNER JOIN product_lists ON favorite_product_id = product_lists.id
            WHERE product_lists.id= '" . $id . "' 
            ";
            ...
            <div class="block2">
                ...
                <div class="item_1">
                    ...
                    <span style="color:green">
                        <dt class="wf-sawarabimincho">
                            <img id="img2" src="./images/<?php echo $list['img'] ?>">
                        </dt>
                        <br>
                        <pre></pre>
                        ...
                        <?php } else { ?>
                            ...
                            <?php } elseif ($array_count >= 1) { ?>
                                ...
                                <form action="./favorite/update_favorite_product.php" method="POST">
                                    ...
                                    <!-- ボタン -->
                                    <div class="favorite_btn">
                                        <!-- ハートに色がついてない画像 を。ここは未ログインしていた時だから、色付きはつけない。
                        ハートを押すと、ログイン画面に遷移する仕組み。 -->
                                        <?php if ($record['is_completed'] == 0) { ?>
                                            <input type="image" src="../icon_img/my_favorite-01.png" alt="dont_favorite" width="210%">
                                        <?php } elseif ($record['is_completed'] == 1) { ?>
                                            <input type="image" src="../icon_img/my_favorite-01.png" alt="add_favorite" width="210%">
                                        <?php } ?>
                                    </div>
                                </form>
                            <?php } ?>
                        ...
                        <!-- "商品を買い物に入れる"ボタン -->
                        <input type="button" class="re-order" value='カートに入れる' onclick="location.href='./cart/cart.php'" style="width: 180px;">
                        <!-- セッションに渡した$id↓ -->
        ...
        <div class="div_migi">
            ...
            <div class="div_edit_r3">
                ...
                <table>
                    ...
                    <td><span style="color:green"><?php echo $list['price'] ?></span>円</dt>
                    </td>

                    <!-- データベースからFETCH()した、メーカー名  -->
                    <td width="111px">&nbsp;&nbsp;&nbsp;<span style="color:green"><?php echo $list['names'] ?></span></dt>
                    </td>

                    <!-- データベースからFETCH()した、 内容量 -->
                    <td><span style="color:green"><?php echo $list['amount'] ?></span></dt>
                    </td>

                    <!-- データベースからFETCH()した、 原産国 -->
                    <td><span style="color:green"><?php echo $list['coo'] ?></span></dt>
                    </td>
                ...
                <div class="div_w3">
                    ...
                    <span style="color:green;font-size:24px">
                        <dt class="wf-sawarabimincho">■商品説明</dt>
                    </span>
                ...
                <div class="div_w3">
                    ...
                    <span style="color:green;font-size:24px">
                        <dt class="wf-sawarabimincho">■適した料理・用途</dt>
                    </span>
                ...
                <div class="div_w3">
                    <!-- データベースからFETCH()した、特徴 -->
                    <span style="color:green;font-size:24px">
                        <dt class="wf-sawarabimincho">■成分・効能</dt>
                    </span>
