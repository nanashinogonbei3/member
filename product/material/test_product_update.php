...
<head>
    ...
    <script src="pause_play.js"></script>
...
<div id="carouselInner">
    ...
    <?php foreach ($productList as $key =>$v) : ?>
        ...
        <ul class="column">
            ...
            <div class="btn_carousel"> 
                 <!-- フォーム⓵ [材料に追加] -->
                 <form action="update_product_material.php" method="GET">
                        ...
                        <div id="carouselButtons">
                            <button type="button" id="playButton" class="btn btn-light btn-sm"><svg width='12' height='12' fill='#333' viewBox='0 0 12 12' aria-hidden="true"><polygon points='0,0 0,12 12,6'/></svg><span class="sr-only">開始</span></button>
                            <button type="button" id="pauseButton" class="btn btn-light btn-sm"><svg width='12' height='12' fill='#333' viewBox='0 0 12 12' aria-hidden="true"><path d='M0,0 L0,12 L5,12 L5,0 L0,0 M7,0 L7,12 L12,12 L12,0, L7,0'/></svg><span class="sr-only">一時停止</span></button>
                        </div>
                        <!-- 一時停止ボタンおわり -->
                        ...
                        <div class="back">  
                            <!-- 戻る -->
                            <input type="button" id="button3" onclick="window.history.back();" value="前のページに戻る">
                        </div>   
                    </form>
            </div>
