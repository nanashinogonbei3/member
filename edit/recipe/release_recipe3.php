...
つまり、材料のなかに商品の登録が3つ以上あれば、カルーセル表示させる。 -->
                    ...
                    <div id="carousel">
                        ...
                        <div id="carouselInner">
                            ...
                            <?php foreach ($product as $v) : ?>
                                ...
                                <ul class="column">
                                    <!-- リンク先 商品詳細ページ -->
                                    <li><a href="../../product/product_introduction_no_login.php?id=<?php echo $v['id'] ?>">
                            ...
                            location.href='../../product/product_introduction_no_login.php?id=<?php echo $v['id'] ?>'">商品の詳細</button>
                                        </div>
                                    </li>
                                </ul>
    ...
    <?php if (!empty($advice)) : ?>
        ...
        <div class="bottom">
            ...
            location.href='../../top/index.php?id= action=rewrite'" value='レシピを選び直す'>
