...
<body>
   ...
   <div class='inline_block_1'>
    ...
    <div class='div_p'>
        ...
        <dt class="title_font">アドバイスの編集画面</dt></span>
...
<form action="" method="POST">
    ...
    <?php if(!empty($_POST['advice'])) { ?>
        <textarea class="textarea"  name="advice" rows="8" cols="40" placeholder = 'レシピのアドバイスを入力'
        maxlength="255" value="<?php print(htmlspecialchars($_POST['advice'],
        ENT_QUOTES)); ?>"></textarea>
    <?php } else { ?>
        <textarea class="textarea"  name="advice" rows="8" cols="40" placeholder = 'レシピのアドバイスを入力'
...
<dt><span style="font-size:13px; color:#555555" >
        ...
        <div class="bottun3">                
            ...
            value="登録" name="send" style="width: 60px;
            color: #4F5902;
            height: 33px;
            font-size: 16px;
            border-radius: 2px;
...
<form method="POST" action="update_advice.php">
        ...
        <p>
            <textarea name="advice" rows="200" cols="150" placeholder = 'レシピのアドバイスを入力'
            maxlength="255" value=""> </textarea>
