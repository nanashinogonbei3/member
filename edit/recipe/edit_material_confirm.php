...
<body>
        ...
        <div class='div_p'><dt class="wf-sawarabimincho"><span style="font-size:18px;color:green">
        <span style="font-size:21px"><?php echo $record['recipe_name']; ?></span><span style="font-size:16px;color:#000000">の材料</span></dt>
            ...
            <div class="div_logout">
                        <input type="button"  value='みんなのレシピ' class="logout_btn"
                        onclick="location.href='../../top/confirm.php'" >
                            <!-- /member/logout/process.php -->
            </div> 
           
      
            <input type="button" class="re-order" onclick="window.history.back();" 
            value="前のページに戻る">
    ...
    <!-- フォーム⓸ [商品名で検索🔍] -->
     <div class="listserch">
        <form action="../../product/material/serch_material5_multiple.php" method="GET" onclick="open_preview();" width=600px heiht=500px>
                        ...
                        <input type="hidden" name="parent_category_id" id="material_category"
                        value='<?php echo $parent_category_id ?>' >
...
<!-- アコーディオンバーはじまり -->
    ...
    <form action="update_materials.php" method="GET" >
            ...
            <th><dt class="wf-sawarabimincho"></th>
            <th width="45px"><dt class="wf-sawarabimincho"><span style="color:green;font-size:16px"><?php echo $material_name; ?></span></th>
            <th><dt class="wf-sawarabimincho"><span style="color:green;font-size:16px"><?php echo $amount; ?></th>
            <th>
            ...
            <td><dt class="wf-sawarabimincho"></td>
