            ...
            <div class='inline_block_2'>
                ...
                <div class="inline_block_3">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="last_name" size="35" placeholder='山田' maxlength="255" value="" />
                        ...
                        <!-- maxlength= '入力できる制限文字数' -->
                        <input type="text" name="first_name" size="35" placeholder='太郎' maxlength="255" value="" />
                        ...
                        <input type="text" name="members_id" size="35" placeholder='recipe@gmail.com' maxlength="255" value="" />
                        ...
                        <input type="file" name="icon_img" maxlength="255">
                        ...
                        <input type="text" name="phone_number" size="30" placeholder='08012345678' maxlength="11">
                        ...
                        <input type="password" name="password2" placeholder='・・・・・・' maxlength="255">
                        ...
                        <div class="div_img3">
                            ...
                            <dt class="wf-sawarabimincho">
                                <input type="button" value='キャンセル' style="width: 115px; height: 25px" onclick="location.href='../login/join.php?id='">
