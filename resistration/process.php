...
<bod>
   ...
   <div class='inline_block_1'>
        ...
        <div class='div_p'><p class="title_font">会員登録完了</p></div>
            ...
            <div class="inline_block_3">
                ...
                <!-- データベースに登録したテキストデータと画像でーたを出力表示する -->
                            ...
                            <div class="div_font_inline">
                                ...
                                ($_SESSION['personal']['icon_img'], ENT_QUOTES)); ?>">
                                <?php endif; ?>
                        ...
                        <div class="div_font_inline">
                        <input type="button" value='ログイン画面' style="width:20%;padding:10px;font-size:15px;"  
                         onclick="location.href='../login/join.php'" class="btn-border">
                        </div>
            </div>        
