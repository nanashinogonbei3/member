...
<form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="clear-both">
        <input type="text" name="cooking_time" size="11" class="input_height"
        maxlength="240" value="">&nbsp;分
        ...
        <div class="clear-both">
        <input type="text" name="cost" size="11" class="input_height"
        maxlength="120" value="">&nbsp;円
        ...
        <div class="clear-both"> 
        <input type="text" name="how_many_servings" size="11"  class="input_height"
        maxlength="255" value="">&nbsp;人分
        ...
        <input type="date" name="created_date"  class="input_height"
        maxlength="255" value="">
        </label> 
...
<div class="inline_block_3">
    ...
    <th></th>
    <th ><p class='wf-sawarabimincho'>レシピID</p></th>
    <th><p class='wf-sawarabimincho'>レシピネーム</p></th>
    <th><p class='wf-sawarabimincho'>時間</p></th>
    <th><p class='wf-sawarabimincho'>材料費</p></th>
    <th><p class='wf-sawarabimincho'>何人分</p></th>
    <th><p class='wf-sawarabimincho'>完成画像</p></th>
    <th><p class='wf-sawarabimincho'>作成日</p></th>
    </tr>  
<?php 
...
<td width="80px"><p><span style="color:green"><?= (htmlspecialchars($v['recipe_id'], ENT_QUOTES)); ?></span></p></td>
<!-- my_recipeテーブル dbレシピネーム -->
<td width="100px"><p><span style="color:green"><?= (htmlspecialchars($v['recipe_name'], ENT_QUOTES)); ?></span></p></td>
<!-- my_recipeテーブル db調理時間 -->
<td><p><span style="color:green"><?= (htmlspecialchars($v['cooking_time'], ENT_QUOTES)); ?></span>分</p></td>
<!-- my_recipeテーブル dbコスト -->
<td><p><span style="color:green"><?= (htmlspecialchars($v['cost'], ENT_QUOTES)); ?></span>円</p></td>
<!-- my_recipeテーブル db 何人前 -->
<td><p><span style="color:green"><?= (htmlspecialchars($v['how_many_servings'], ENT_QUOTES)); ?></span>人分</p></td>
<!-- my_recipeテーブル db完成画像 -->
<td><p><span style="color:green"><?php if ($v['complete_img'] !== ''): ?>
<!-- もしも画像があったら表示する -->
<img id="compimg" class="img" src="./images/<?php print(htmlspecialchars($v['complete_img'], 
ENT_QUOTES));  ?>" width="135px" height="auto">
<?php endif; ?>
</p></td>
<!-- my_recipeテーブル db   作成日 -->
<td><p><span style="color:green"><?= (htmlspecialchars($v['created_date'], ENT_QUOTES)); ?></span></p></td>
...
<td><input type="submit" class="update" name ="del" 
    value="Delete" onClick="return dispDelete();"
    style ="
    font-size: 12px;
    width: 45px;
    height: 20px; 
