...
<body>
        ...
        <div class='div_p'><p class="title_font">レシピの公開</p>
    
            <!-- みんなのレシピ -->
            <div class="div_login "><input type="button"  value='みんなのレシピ' class="logout_btn"
        ...
        <div class='inline_block_2'>
            ...
            <div class="block1">
                <div class="btn_migi">
                   <div class="btn_migi2">
                    ...
                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                    ...
                                    <?php if ($v['is_released'] == 0) { ?>

                                            <td><input type="radio" name="is_released" value="0" <?= $v['is_released']==0 ?> checked="checked" ></td>
                                            <td class="menu">未公開</td>
                                            <td><input type="radio" name="is_released" value="1" <?= $v['is_released']==1 ?> ></td>
                                            <td class="menu">公開</td>
                                                            
                                    <?php } elseif ($v['is_released'] == 1)  { ?>

                                            <td><input type="radio" name="is_released" value="0" <?= $v['is_released']==0 ?>  ></td>
                                            <td class="menu">未公開</td>
                                            <td><input type="radio" name="is_released" value="1" <?= $v['is_released']==1 ?> checked="checked" ></td>
                                            <td class="menu">公開</td>
                ...
                <?php if ($record['is_released'] == 0 ) : ?>                    
                    ...
                    <!-- 公開  ボタン （青色）-->
                    <input type="submit" name ="pushed" value='レシピを公開'
                    style=" background-color: #9ACFDD; width: 170px; height: 50px; color:gray; border:4px solid #CABAAB; ">
                    
                <?php else : ?>
                    
                    <!-- 非公開  ボタン (緑色）-->
                    <input type="submit" name ="pushed" value='非公開にする'
                    style=" background-color: #EEEC00; width: 170px; height: 50px; color:gray; border:4px solid #CABAAB; ">
                ...
                <!-- レシピを作った人 -->
                <dt>レシピを作った人：<span style="color:green;font-weight:bold;font-size:180%;"><?php echo $m['nickname']; ?></span></dt>


               <div class="line"></div>
                        <!-- データベースからFETCH()した、  レシピID -->
                        <dt class="wf-sawarabimincho">レシピID：
                        <span style="color:green"><?php echo $id ?></span></dt>
                        ...
                        <input type="button" onclick=" 
                                                ...
                                                location.href='./index.php?id= action=rewrite'"
                                                value='レシピを選び直す'
                                                style=" background-color:#FFF587; width: 210px; height: 30px; color:gray; border:5px dashed #F2F0CE; ">
                        ...
                        <!-- データベースからFETCH()した、完成画像 -->      
                            <span style="color:green"><p class="wf-sawarabimincho">完成画像</P>
                        ...
                        <!-- 調理動画を別ウィンドウで再生させます。 -->
                            ...
                            <span style="color:green"><p class="wf-sawarabimincho">調理動画</P>
            ...
            <div class="div_migi">
                ...
                <form action="add_m.php" method="POST" >
                        <table>
                            <thead>
                                <tr>
                                    <th><dt class="wf-sawarabimincho">調理時間</th>
                                    <th><dt class="wf-sawarabimincho">材料費</th>
                                    <th><dt class="wf-sawarabimincho">何人分</th>
                                </tr>
                           </thead>
                           <tbody>
                               <tr>
                        <!-- データベースからFETCH()した、 調理時間 -->
                                   <td><span style="color:green"><?php echo $cooking_time ?></span>分</dt></td>

                        <!-- データベースからFETCH()した、 材料費 -->
                                   <td><span style="color:green"><?php echo $cost ?></span>円</dt></td>

                        <!-- データベースからFETCH()した、 何人分 -->
                                   <td><span style="color:green"><?php echo $how_many_servings ?></span>人分</dt></td>
                               </tr>
                           </tbody>              
                        </table>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th><dt class="wf-sawarabimincho">レシピID</th>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <th><dt class="wf-sawarabimincho">材料名</th>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <th><dt class="wf-sawarabimincho">分量</th>
                                </tr>
                            </thead>
                            <tbody>
                    <!-- 材料入力フォーム -->
...
<p class="p_font_rarge">🔲調理手順</p>
    <dt><!-- 材料テーブルのデータベースからFETCH()した  my_recipeテーブルのID -->
             <p><span style="color:green;font-size:13px">レシピID:<?php echo $v['recipe_id'] ?></span></p></dt>
    ...
    <div class="parent">
        ...
        <div class="div_100p"> 
            ...
            <div class="div_100">
                ...
                <p><span style="color:green;font-size:13px"><td><?php echo  $v['descriptions'] ?></td>
                </span></p>
